...
// ClevoFanControl.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CClevoFanControlApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CClevoFanControlApp 构造

CClevoFanControlApp::CClevoFanControlApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CClevoFanControlApp 对象

CClevoFanControlApp theApp;


// CClevoFanControlApp 初始化

BOOL CClevoFanControlApp::InitInstance()
{
