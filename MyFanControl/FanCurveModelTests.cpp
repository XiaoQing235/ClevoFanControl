...
void TestMissingIoAndVersionedName()
{
	...
	const std::string legacyPath = directory.File("MyFanControl.v3.cfg");
	Expect(ConfigStore::FileName() == std::string("MyFanControl.json"), "ConfigStore should use the JSON file name");
